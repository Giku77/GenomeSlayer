...
public static class DataTableManger
{
    ...
    enemyTable.Load(EnemyTable.EnemyTableId);
    tables.Add(EnemyTable.EnemyTableId, enemyTable);
    }
    ...
    public static EnemyTable EnemyTable => Get<EnemyTable>(EnemyTable.EnemyTableId);
